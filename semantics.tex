...
for the standard linear temporal logic formulas~\cite{ManneP92}. We only recall the semantics for $\X$ and $\until$ as follows:
\begin{eqnarray*}
...
those from every neighbor of $s$. Informally, it is
