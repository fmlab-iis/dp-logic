...
model checkers. Privacy checking with existing tools can be attained
with minimal efforts and overheads. Hopefully, more interaction
between model checking and privacy analysis will follow.
...
essentially expressiveness for free.
...
involving infinite behaviors can also be expressed. (II) We model several differential privacy mechanisms, including stream processing, in Markov chains or Markov decision processes.
