...
\mathit{at}_1) \wedge \dpriv{\ln 4}{0} (\F \mathit{at}_2)p
\]
...
\wedge
\bigwedge_{k \in \bbfN}
\dpriv{\ln 4}{0} \X^k \mathit{at}_{00} \wedge
\dpriv{\ln 4}{0} \X^k \mathit{at}_{01} \wedge
\dpriv{\ln 4}{0} \X^k \mathit{at}_{10} \wedge
\dpriv{\ln 4}{0} \X^k \mathit{at}_{11}.
\]
