...
$1/2$-geometric mechanism gives $(2, 0)$-differential privacy. By
composition theorem, the steaming data analysis mechanism in
Algorithm~\ref{algorithm:frequency-estimator} is $(4,
...
\[
\dpriv{4}{0} \F 0 \wedge \dpriv{4}{0} \F 1 \wedge \dpriv{4}{0} \F 2
\]
...
\wedge
\bigwedge_{k \in \bbfN}
\dpriv{4}{0} \X^k 00 \wedge 
\dpriv{4}{0} \X^k 01 \wedge 
\dpriv{4}{0} \X^k 10 \wedge 
\dpriv{4}{0} \X^k 11.
\]
