...
The formula $\dpriv{\ln 3}{0} (\X Y)$ \lz{$\X Y$ looks a bit weired?} holds in state $s$ if for  $t$ with $sNt$, the probability of satisfying $\X Y$ from $s$ and $t$ satisfy:
